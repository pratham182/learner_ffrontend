...
const Register=()=>{
    const [type,SetText]=useState(false)
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <form class="space-y-6" action="#" method="POST">
      ...
      <div >
        ...
        <div class="mt-1 flex">
          <input id="password" name="password" type={type?'password':'text'} autocomplete="current-password" required class="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
    ...
    <p class="mt-10 text-center text-sm text-gray-500">
      Have a account?
      <a href="#" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500 ml-1">Signup</a>
    </p>
  </div>
</div>
    </div>
